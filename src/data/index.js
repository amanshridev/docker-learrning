...
export const homefeaturesData = [
    { id: "1", heading: 'Direct Connections', content: 'Get direct access to the professional emails and contact numbers of HR representatives in various industries' },
    { id: "2", heading: 'Effortless Networking', content: 'Connect with recruiters seamlessly by enhancing your job application process with accurate and up-to-date information' },
    { id: "3", heading: 'Time Optimization', content: 'Save time and energy by easily refreshing your contact list with the click of a button, ensuring efficient job search' },
];
...
export const headerData = [
    { id: "1", main_heading: 'Unlock Your Career Potential', sub_heading: 'Experience the advantages of utilizing Vijay Rath for your job search' },
];
